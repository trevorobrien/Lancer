...
(function(){
    ...
    _shoprunner_com.retailerID = 'CKI';
    _shoprunner_com.loginValidationURL = '/webapp/wcs/stores/servlet/ValidatePVHSRToken?storeId=10751';
    ...
    /*
         ...
         * 2 - Production
         */
    _shoprunner_com.environmentID = srEnvironmentId;
    _shoprunner_com.sendOrderConfirm = true;
    _shoprunner_com.onLoadCallCustomFunction = 'updateShipmode';
    ...
    _shoprunner_com.checkout.enabled = prCheckoutEnabled;
    _shoprunner_com.checkout.singleProductBuyNowEnabled = prProductBuy;
    _shoprunner_com.checkout.cartBuyNowEnabled = prCartBuy;
    _shoprunner_com.checkout.partnerAPIEndPoint = 'APIForPayRunner';
    _shoprunner_com.checkout.onCartAbandonCallCustomFunction = 'postAbandonCall';
